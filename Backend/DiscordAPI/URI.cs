...
namespace DiscordREQ.Backend.DiscordAPI
{
    internal class URI
    {
        ...
        //| CHANNEL URI |\\
        internal static string SetReactUrl            = $"{BaseUrl}/channels/CHANID/messages/MSGID/reactions/ENCODEDREACT/%40me";
        ...
        //| GUILD URI |\\
        internal static string CreateGroupUrl         = $"{BaseUrl}/channels/DMID/recipients/USRID";
